	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$val -> price}}</td>
				<td class="td-manage">
					<a title="编辑" href="javascript:;" onclick="admin_edit('专业编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
