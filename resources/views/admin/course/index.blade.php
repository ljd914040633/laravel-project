		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage">
					...
					@endif 
					<a title="编辑" href="javascript:;" onclick="admin_edit('课程编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
